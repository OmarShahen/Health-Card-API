...
router.get(
  '/registrations/clubs/:clubId/stats',
  tokenMiddleware.adminAndManagmentPermission,
  verifyIds.verifyClubId, 
...
router.get(
  '/registrations/chain-owners/:ownerId',
...
router.get(
  '/registrations/chain-owners/:ownerId/stats',
  tokenMiddleware.adminAndOwnerPermission,
  verifyIds.verifyChainOwnerId, 
...
router.get(
  '/registrations/chain-owners/:ownerId/payments',
  tokenMiddleware.adminAndOwnerPermission,
  verifyIds.verifyChainOwnerId, 
...
router.get(
  '/registrations/members/:memberId',
  tokenMiddleware.appUsersPermission,
...
router.get(
  '/registrations/packages/:packageId',
  tokenMiddleware.adminAndManagmentPermission,

...
router.get('/v1/reviews/experts/:userId/stats/detailed', authorization.allPermission, verifyUserId, function (request, response) {
  return reviewsController.getExpertDetailedReviewsStats(request, response);
});

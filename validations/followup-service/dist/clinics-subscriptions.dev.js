...
var addClinicSubscription = function addClinicSubscription(clinicSubscriptionData) {
  var clinicId = clinicSubscriptionData.clinicId,
      paid = clinicSubscriptionData.paid,
      isActive = clinicSubscriptionData.isActive,
      startDate = clinicSubscriptionData.startDate,
      endDate = clinicSubscriptionData.endDate;
  if (!clinicId) return {
    isAccepted: false,

...
const customRegistrationData = (registrationData) => {

    const { clubId, memberId, staffId, packageId, paid, registrationDate } = registrationData
    ...
    if(!registrationDate) return { isAccepted: false, message: 'Registration Date is required', field: 'registrationDate' }

    if(!validator.isDateValid(registrationDate)) return { isAccepted: false, message: 'Registration date formate is invalid', field: 'registrationDate' }
...
module.exports = { registrationData, customRegistrationData } 
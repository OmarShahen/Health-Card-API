...
var getDoctorEncounters = function getDoctorEncounters(request, response) {
  ...
  return regeneratorRuntime.async(function getDoctorEncounters$(_context4) {
    while (1) {
...
var getEncounter = function getEncounter(request, response) {
  ...
  return regeneratorRuntime.async(function getEncounter$(_context5) {
    while (1) {
...
var updateEncounter = function updateEncounter(request, response) {
  ...
  return regeneratorRuntime.async(function updateEncounter$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 8:
          updatedEncounter = _context6.sent;

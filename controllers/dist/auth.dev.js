...
var verifyDemographicInfo = function verifyDemographicInfo(request, response) {
  var dataValidation;
  return regeneratorRuntime.async(function verifyDemographicInfo$(_context5) {
    while (1) {
...
var verifySpecialityInfo = function verifySpecialityInfo(request, response) {
  ...
  return regeneratorRuntime.async(function verifySpecialityInfo$(_context6) {
    while (1) {
...
var setUserVerified = function setUserVerified(request, response) {
  ...
  return regeneratorRuntime.async(function setUserVerified$(_context8) {
    while (1) {
...
var addUserEmailVerificationCode = function addUserEmailVerificationCode(request, response) {
  ...
  return regeneratorRuntime.async(function addUserEmailVerificationCode$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        ...
        case 15:
          newEmailverification = _context9.sent;
...
var sendEmail = function sendEmail(request, response) {
  var mailData;
  return regeneratorRuntime.async(function sendEmail$(_context10) {
    while (1) {
...
var verifyResetPasswordVerificationCode = function verifyResetPasswordVerificationCode(request, response) {
  var dataValidation, _request$body3, email, verificationCode, userList;
  ...
  return regeneratorRuntime.async(function verifyResetPasswordVerificationCode$(_context14) {
    while (1) {
      switch (_context14.prev = _context14.next) {
        ...
        case 4:
          _request$body3 = request.body, email = _request$body3.email, verificationCode = _request$body3.verificationCode;
          _context14.next = 7;
          return regeneratorRuntime.awrap(UserModel.find({
            email: email,
            isVerified: true,
...
var resetPassword = function resetPassword(request, response) {
  var dataValidation, _request$body4, email, verificationCode, password, userList, user, userId, newUserPassword, updateUserData, updatedUser;
  ...
  return regeneratorRuntime.async(function resetPassword$(_context15) {
    while (1) {
      switch (_context15.prev = _context15.next) {
        ...
        case 4:
          _request$body4 = request.body, email = _request$body4.email, verificationCode = _request$body4.verificationCode, password = _request$body4.password;
          _context15.next = 7;
          return regeneratorRuntime.awrap(UserModel.find({
            email: email,
            isVerified: true,
